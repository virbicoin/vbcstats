  ...
  return (
    <header className="bg-gradient-to-r from-[#0a0f1a] via-[#0d1421] to-[#0a0f1a] border-b border-[#1e3a5f]/50 backdrop-blur-sm">
      <nav className="container-full mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        <Link
          href="/"
          className="flex items-center gap-3 text-xl font-bold nav-link text-white hover:text-blue-300 transition-all duration-200 group"
        >
        ...
        <ul className="flex items-center space-x-1">
          <li>
            <Link
              href="/"
              className="nav-link text-gray-300 hover:text-blue-400 flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-blue-500/10 transition-all duration-200"
            >
