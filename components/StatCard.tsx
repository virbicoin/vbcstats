...
const StatCard: React.FC<StatCardProps> = ({ icon, label, value, className = 'text-blue-400' }) => {
  return (
    <div
      className="group relative bg-gradient-to-br from-[#0d1421] to-[#0a1018] rounded-xl border border-[#1e3a5f]/50 p-5 
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className={`text-2xl font-bold tracking-tight ${className}`}>{value}</div>
      </div>
    </div>
  );
};
